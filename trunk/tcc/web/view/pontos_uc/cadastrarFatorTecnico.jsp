                    ...
                    <div class="row-fluid add-top">
                        <div class="span12">
                            <p style="word-wrap: break-word;">
                                O Fator de Complexidade Técnica (FCT) é determinado atribuindo-se um peso de 0 a 5 em determinadas características técnicas que podem atribuir dificuldade ao desenvolvimento do software.<br>
                                O valor <strong>0</strong> indica que não está presente ou não influencia; o valor <strong>5</strong> indica influência significativa através de todo o processo.
                            </p>
                        </div>
                    </div>
                </div>
