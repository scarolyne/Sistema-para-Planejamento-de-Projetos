...
$(document).ready(function(){ 
    ...
    var styleswitcherstr = ' \
        ...
        <div class="clear"></div>  \
        <h3>Theme Style</h3> \
        <a href="../boxed/index.html" class="button font-size-10">Boxed Theme</a> \
        </div><!-- End content --> \
        ';
...
$("#addProjeto").click(function() {
    $("#cadProjeto").slideToggle("slow", function(){
    });
});

$("#aprovProjeto").click(function() {
    $("#pendProjeto").slideToggle("slow", function(){
    });
});
