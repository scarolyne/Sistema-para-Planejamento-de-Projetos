<%-- 
    Document   : config
    Created on : 24/10/2014, 13:01:52
    Author     : Carol
--%>
...
<head>
    ...
    <meta name="author" content="scarolyne">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/modernizr.custom.79639.js"></script>
